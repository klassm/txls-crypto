...
import type { Provider, CreateProviderDto, UpdateProviderDto } from "../../../types/index.js";
import { ProviderType } from "../../../types/index.js";
import type { CsvImporter } from "../../sources/types.js";
...
export class ProvidersService {
  ...
  getAvailableProviders(): Array<{
    ...
    return Object.entries(providerMetadata).map(([key, value]) => ({
      ...
      csvImportAllowed: providerConfigs[key as ProviderType] !== undefined,
    }));
  }
  ...
  private entityToSchema(
    ...
    return {
      ...
      csvImportAllowed: providerConfigs[entity.provider as ProviderType] !== undefined,
