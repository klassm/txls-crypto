...
import { useAccount, usePortfolioHistory, useSources, useApiSettings, useAccountAssets } from "../../hooks";
				...
				<>
					...
					<Box>
						...
						{supportsManualStaking && (
							...
							<AssetDistributionSummary history={portfolioHistory} assets={accountAssets} />
							</Box>
						</Grid>
